...
$book['01']['image'] = 'Since there is only one heaven, the doubling of the trigram Ch\'ien, of which heaven is the image, indicates the movement of heaven.  One complete revolution of heaven makes a day, and the repetition of the trigram means that each day is followed by another.  This creates the idea of time.  Since it is the same heaven moving with untiring power, there is also created the idea of duration both in and beyond time, a movement that never stops nor slackens, just as one day follows another in an unending course.  This duration in time is the image of the power inherent in the Creative. <br>
...
A place of transition has been reached, and free choice can enter in.  A twofold possibility is presented to the great man: he can soar to the heights and play an important part in the world, or he can withdraw into solitude and develop himself.  He can go the way of the hero or that of the holy sage
who seeks seclusion.  There is no general law of his being.  If the individual acts consistently and is true to himself, he will find the way that is appropriate for him.  This way is right for him and without blame.
';

$book['01']['line5'] = 'Nine in the fifth place means: Flying dragon in the heavens.
It furthers one to see the great man.<br>
Here the great man has attained the sphere of the heavenly beings.  His influence spreads and becomes visible throughout the whole world.  Everyone who sees him may count himself blessed.  Confucius says about this line:<br>
...
To go one\'s way with sincerity brings clarity. How could there be blame in this?<br>
It often happens, when a man exerts a certain amount of influence, that he obtains a following by condescension toward inferiors, but the people who attach themselves to him are not honest in their intentions.
...
echo '<input type="text" name="chapt" value="">';
echo '<input type="submit" name="testsubmit">';
echo'</form>';
...
# echo $_POST['chapt'];
if ( !empty($pageval) ) {
	echo '<div id="formatdiv" style="width: 800px;">';

	echo '<h3>Description</h3>';
	print($book[$pageval]['desc']);
	echo '<br><br>';
	echo '<h3>Judgement</h3>';
	print($book[$pageval]['judge']);
	echo '<br><br>';
	echo '<h3>Image</h3>';
	print($book[$pageval]['image']);
	echo '<br><br>';
	echo '<h3>Line 1</h3>';
	print($book[$pageval]['line1']);
	echo '<br><br>';
	echo '<h3>Line 2</h3>';
	print($book[$pageval]['line2']);
	echo '<br><br>';
	echo '<h3>Line 3</h3>';
	print($book[$pageval]['line3']);
	echo '<br><br>';
	echo '<h3>Line 4</h3>';
	print($book[$pageval]['line4']);
	echo '<br><br>';
	echo '<h3>Line 5</h3>';
	print($book[$pageval]['line5']);
	echo '<br><br>';
	echo '<h3>Line 6</h3>';
	print($book[$pageval]['line6']);
